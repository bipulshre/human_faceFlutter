...
import 'package:human_generator/services/drawing.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void saveToImage(List<DrawingArea> points) async {
    ...
    final canvas =
        Canvas(recoder, Rect.fromPoints(Offset(0.0, 0.0), Offset(200, 200)));
  ...
  void fetchResponse(var base64Image) async {
    ...
    try {
      ...
      print('error occured k garne aaba oh no');
      return null;
    }
  }
